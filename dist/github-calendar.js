            ...
            t.exports = function(b, e, m) {
                ...
                return function g() {
                    return m.getCalendar(e).then(function(e) {
                        ...
                        }), p.appendChild(i), p.appendChild(c), p.appendChild(l)), b.innerHTML = p.innerHTML, !0 === m.tooltips && (d = b, (f = document.createElement("div")).classList.add("day-tooltip"), d.appendChild(f), d.querySelectorAll("rect.day").forEach(function(e) {
            ...
            t.exports = function(e) {
                ...
                return e.split("\n").slice(2).map(function(e) {
                    ...
                    r && (t = {
                        ...
                        count: a,
                        level: i.indexOf(r)
                    }, 0 === s.current_streak && (s.current_streak_range[0] = t.date), t.count ? (++s.current_streak, s.last_year += t.count, s.last_contributed = t.date, s.current_streak_range[1] = t.date) : (o(), s.current_streak = 0), u.push(t), s.days.push(t))
                }), o(), s
            }
        }, {
